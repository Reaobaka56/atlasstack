    ...
    def _load_custom_rules(self) -> List[Dict]:
        ...
        return [
            ...
            },
            {
                ...
                "pattern": r"(?:open|os\.path\.join)\s*\([^)]*\.\.[\/]",
                "severity": "high",
                "confidence": "medium",
                "message": "Potential path traversal vulnerability detected",
                "remediation": "Validate and sanitize file paths; use os.path.realpath and check against allowed base dirs",
                "cwe_id": "CWE-22",
                "languages": ["python"],
            },
            {
            ...
            },
            {
                ...
                "severity": "high",
                "confidence": "high",
                "message": "Unsafe yaml.load() usage — use yaml.safe_load() instead",
                "remediation": "Replace yaml.load() with yaml.safe_load() to prevent arbitrary code execution",
                "cwe_id": "CWE-502",
                "languages": ["python"],
            },
            {
                ...
                "remediation": "Pass command as a list without shell=True",
                "cwe_id": "CWE-78",
                "languages": ["python"],
            },
        ]
