...
# Default target
help:
	@echo "AtlasStack - Available Commands:"
	@echo ""
...
# ──────────────────────────────────────────────────────────
# Lite Mode (no Docker required)
# ──────────────────────────────────────────────────────────

.PHONY: lite-install lite-backend lite-frontend lite-dev
...
lite-dev:
	...
	python test_app2.py & cd clients/web && npm run dev
